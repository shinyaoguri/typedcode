...
export const ja: VerifyTranslationKeys = {
  ...
  result: {
    ...
    screenshotsChainOnly: '⚠ チェーンに記録された${count}枚がマニフェストに存在しません（剥ぎ取りの可能性）',
    screenshotsNotChecked: '未検査（エクスポート ZIP を読み込むと検証されます）',
  ...
  trust: {
    ...
    issueScreenshotsChainOnly: 'チェーンに記録された${count}枚がマニフェストに無い（剥ぎ取りの可能性）',
