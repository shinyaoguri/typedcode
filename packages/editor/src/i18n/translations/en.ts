...
export const en: TranslationKeys = {
  ...
  screenCapture: {
    ...
    // Error dialog
    errorTitle: 'Screen Share Error',
    errorUnknown: 'An unknown error occurred',
    errorNotAllowed: 'Screen sharing was not permitted',
    errorNotAllowedDesc: 'User denied screen sharing or it was blocked by browser settings.',
    errorNotSupported: 'Screen Capture API is not supported',
    errorNotSupportedDesc: 'Your browser does not support the screen capture feature.',
    errorNotReadable: 'Could not read the screen',
    errorNotReadableDesc: 'Screen capture failed at the hardware or OS level.',
    errorOverconstrained: 'Cannot satisfy the specified constraints',
    errorOverconstrainedDesc: 'The requested screen sharing settings are not supported.',
    errorAborted: 'Screen sharing was aborted',
    errorAbortedDesc: 'An unexpected error occurred during screen sharing.',
    errorSecurityError: 'Security Error',
    errorSecurityErrorDesc: 'Screen sharing was blocked by security policy. Please ensure you are using HTTPS.',
    ...
    solutionRefresh: 'Refresh the page',
    solutionCloseOtherTabs: 'Close other tabs and windows to free up memory',
    solutionCheckPermissions: 'Check screen sharing permissions in browser settings',
    solutionUseChrome: 'Use Chrome or Edge browser',
    solutionSelectMonitor: 'Select from the "Entire Screen" tab in the screen sharing dialog',
    solutionClearBrowserData: 'Clear browser cache and data',
  ...
  notifications: {
    ...
    pasteDetected: 'External Paste (${length} characters)',
    internalPasteDetected: 'Internal Paste (${length} characters)',
    dropDetected: 'Drop (${length} characters)',
    copyDetected: 'Copy (${length} characters)',
  ...
  events: {
    ...
    paste: 'External Paste: ${length} chars',
    internalPaste: 'Internal Paste: ${length} chars',
  ...
  author: {
    ...
    problem: {
      ...
      variantPlaceholder: 'Only if it varies per student',
    ...
    token: {
      ...
      hint: 'Examinees unlock the problem with this code. It is not stored in the plaintext package and cannot be recovered if lost.',
      embedPubkey: 'Embed the public key in the package (long-term verifiability; trust anchor is always the registry)',
    },
    build: {
      button: 'Generate and download .tcexam',
      working: 'Generating…',
      errorNoKey: 'Please enter the keyId and the private signing key (JWK).',
      errorGeneric: 'Generation failed. Please check your inputs.',
    },
    result: {
